...
const KNOWN_GLOBALS = new Set((
  ...
  "CastSpell SpellIsTargeting SpellStopTargeting TargetUnit TargetLastTarget ClearTarget TargetNearestEnemy " +
  "AttackTarget GetMouseFocus UnitHealth UnitDebuff CancelPlayerBuff GetNumShapeshiftForms GetShapeshiftFormInfo " +
  "CastShapeshiftForm UseContainerItem UseInventoryItem GetContainerItemCooldown GetInventoryItemCooldown " +
  "PickupContainerItem PickupInventoryItem AutoEquipCursorItem CursorHasItem MerchantFrame BankFrame TradeFrame " +
  "MailFrame AuctionFrame SendChatMessage GetNumRaidMembers GetNumPartyMembers " +
